...
import haderImage from '../../../images/hmbg2.jpg'
const HeaderMain = () => {
    return (
        <main class="row BG d-flex align-item-center">
            <div className="col-md-4 offset-1">
                <br></br>
            <h1 style={{color: 'tomato',fontSize: '18px', fontFamily: 'Zen Dots'}}> <br/> <span style={{color: 'black' ,fontFamily: 'Krona One',fontSize: '22px'}}> As-salamu Alaykum </span> <br/>  Enjoy Your Food rastaurant  <br/> <br/> <span style={{color: 'black' ,fontFamily: 'Krona One',fontSize: '50px'}}> Fresh & Testy </span></h1>
